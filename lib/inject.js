...
module.exports.injectScript = function (htmlContent) {
  const loadingImage =
    ...
    "https://i.loli.wiki/public/240202/loading.svg";
  const errorTipImage =
  ...
  const injectedStyles = `.lazyload-wrap {
    position: relative;
    display: block;
  }
  ...
  .lazyload-wrap.loaded .placeholder {
  ...
  if (/<\/body>/gi.test(htmlContent)) {
    htmlContent = appendScript(settingsContent, htmlContent);
